...
void UPDLootWidget::RefreshLootGrid()
{
	...
	for (int32 SlotIndex = 0; SlotIndex < SlotCount; ++SlotIndex)
	{
		...
		// Stash ?„ì ¯ê³??™ì¼?˜ê²Œ SizeBox ë¡??€ ?¬ê¸° ê³ ì • ??UniformGrid ê°€ ë¶€ëª??¬ì´ì¦ˆì— ?˜ì–´?˜ì? ?Šë„ë¡?
...
void UPDLootWidget::HandleLootSlotLeftClicked(UPDInventorySlotWidget* /*SlotWidget*/, int32 ClickedSlotIndex)
{
	...
	// ?¨ë°œ ?•ì±…: ì¢Œí´ë¦?1??= ?¬ë¡¯ ?„ì²´ ?¸ë²¤? ë¦¬ë¡??´ë™.
	// ?¥í›„ ?œëž˜ê·¸ì•¤?œë¡­/?˜ëŸ‰ ?ì—… ???•ìž¥ ??HandleLootSlotLeftClicked ë¶„ê¸° ?ëŠ” ë³„ë„ ?¸ë“¤??ì¶”ê?.
